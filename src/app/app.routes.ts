...
export const routes: Routes = [
 ...
 {
 // Gestión de Usuarios (ASU / GS sucursal).
 path: 'admin/usuarios',
 loadComponent: () =>
 ...
 {
 // vista unificada de Roles y Permisos (tabs).
 path: 'admin/roles',
 loadComponent: () =>
 ...
 {
 // Perfil Institucional de la Empresa (ASU).
 path: 'empresa',
 loadComponent: () =>
 ...
 {
 // Módulo Catálogo: rutas lazy children bajo /catalogo.
 path: 'catalogo',
 children: CATALOGO_ROUTES,
 },
 {
 // Módulo Inventario: rutas lazy children bajo /inventario.
 path: 'inventario',
 canActivate: [authGuard],
 ...
 {
 // Módulo Reservas: rutas lazy children bajo /reservas.
 path: 'reservas',
 canActivate: [authGuard],
 ...
 {
 // Módulo Ventas: rutas lazy children bajo /ventas.
 path: 'ventas',
 canActivate: [authGuard],
 data: { roles: ['GS', 'V'], strict: true },
 loadChildren: () =>
 ...
 {
 // Gestión de Devoluciones (vista operativa GS/V).
 path: 'devoluciones',
 loadComponent: () =>
 ...
 {
 // Vista dedicada de Notificaciones (bandeja completa).
 path: 'notificaciones',
 loadComponent: () =>
 ...
 {
 // Gestión de Descuentos / Cupones (GS).
 path: 'descuentos',
 loadComponent: () =>
 ...
 {
 // Módulo Probador Virtual AR: ruta lazy bajo /probador-virtual.
 ...
 {
 // Asistente Virtual Inteligente y Recomendaciones de Moda IA (Cliente).
 path: 'asistente-ia',
 loadComponent: () =>
 ...
 {
 // Carrito de Compras del Cliente (mock).
 path: 'carrito',
 loadComponent: () =>
 ...
 {
 // Checkout / Confirmación de compra (mock).
 path: 'checkout',
 loadComponent: () =>
 ...
 {
 // Módulo Agencias de Reparto: GS y D.
 path: 'agencias',
 canActivate: [authGuard],
 data: { roles: ['GS', 'D'], strict: true },
 loadChildren: () =>
