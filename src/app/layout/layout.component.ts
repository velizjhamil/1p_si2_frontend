...
export const MODULES: MenuModule[] = [
 ...
 roles: ['ASU'],
 items: [
 { label: 'Usuarios', icon: 'users', route: '/admin/usuarios', roles: ['ASU'] },
 { label: 'Roles y Permisos', icon: 'shield', route: '/admin/roles', roles: ['ASU'] },
 ],
 },
 {
 ...
 roles: ['ASU'],
 items: [
 { label: 'Sucursales', icon: 'pin', route: '/sucursales', roles: ['ASU'] },
 { label: 'Temporadas', icon: 'calendar', route: '/catalogo/temporadas', roles: ['ASU'] },
 { label: 'Productos', icon: 'shirt', route: '/catalogo/productos', roles: ['ASU'] },
 { label: 'Categorías', icon: 'tag', route: '/categorias', roles: ['ASU'] },
 { label: 'Tallas', icon: 'tag', route: '/catalogo/tallas', roles: ['ASU'] },
 ],
 },
 {
 ...
 roles: ['GS'],
 items: [
 { label: 'Personal', icon: 'users', route: '/admin/usuarios', roles: ['GS'] },
 { label: 'Proveedores', icon: 'truck', route: '/proveedores', roles: ['GS'] },
 { label: 'Inventario', icon: 'boxes', route: '/inventario', roles: ['GS'] },
 { label: 'Descuentos', icon: 'percent', route: '/descuentos', roles: ['GS'] },
 { label: 'Devoluciones', icon: 'undo', route: '/devoluciones', roles: ['GS'] },
 { label: 'Ventas', icon: 'register', route: '/ventas', roles: ['GS'] },
 { label: 'Reservas', icon: 'clock', route: '/reservas/gestion', roles: ['GS'] },
 { label: 'Envíos', icon: 'truck', route: '/envios', roles: ['GS'] },
 { label: 'Agencias Reparto', icon: 'building', route: '/agencias', roles: ['GS'] },
 { label: 'Reportes', icon: 'chart', route: '/reportes', roles: ['GS'] },
 { label: 'Notificaciones', icon: 'bell', route: '/notificaciones', roles: ['GS'] },
 ],
 },
 {
 label: 'Operaciones',
 ...
 roles: ['V'],
 items: [
 { label: 'Ventas', icon: 'register', route: '/ventas', roles: ['V'] },
 { label: 'Devoluciones', icon: 'undo', route: '/devoluciones', roles: ['V'] },
 { label: 'Reservas', icon: 'clock', route: '/reservas/gestion', roles: ['V'] },
 { label: 'Checkout', icon: 'card', route: '/checkout', roles: ['V'] },
 ],
 },
 {
 label: 'Logística',
 ...
 roles: ['D'],
 items: [
 { label: 'Envíos', icon: 'truck', route: '/envios', roles: ['D'] },
 { label: 'Agencias', icon: 'building', route: '/agencias', roles: ['D'] },
 ],
 },
 {
 label: 'Tienda',
 ...
 roles: ['C'],
 items: [
 { label: 'Catálogo', icon: 'shirt', route: '/catalogo/productos', roles: ['C'] },
 { label: 'Asistente IA', icon: 'sparkles', route: '/asistente-ia', badge: 'IA', roles: ['C'] },
 { label: 'Carrito', icon: 'cart', route: '/carrito', roles: ['C'] },
 { label: 'Checkout', icon: 'card', route: '/checkout', roles: ['C'] },
 { label: 'Reservas', icon: 'clock', route: '/reservas/gestion', roles: ['C'] },
 { label: 'Probador Virtual', icon: 'camera', route: '/probador-virtual', badge: 'IA', roles: ['C'] },
 { label: 'Notificaciones', icon: 'bell', route: '/notificaciones', roles: ['C'] },
 ],
 },
];
...
export class LayoutComponent {
 ...
 /** carrito global — contador de ítems para el badge del header. */
 ...
 // limpiar la cache de notificaciones del store al deslogear
