...
/**
 * Gestión de Productos de Ropa (solo ASU gestiona) — BACKEND REAL.
...
export class ProductosComponent implements OnInit {
 ...
 productoDetalle = signal<ProductoRopa | null>(null);
 ...
 /** Catálogos FK: categorías, tallas/colores, proveedores. */
 cargarCatalogos(): void {
 // Categorías (mismo servicio )
 ...
 // Proveedores: solo alimentan el formulario de gestión
 ...
 // ------------------------------------------------------------------ modal detalle
 abrirModalDetalle(producto: ProductoRopa): void {
