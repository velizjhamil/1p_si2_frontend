...
/**
 * (Gestionar productos): la GESTIÓN web es solo del ASU; el Cliente conserva la
...
describe('ruta de consulta /catalogo/productos', () => {
...
describe('gestión de productos solo ASU', () => {
