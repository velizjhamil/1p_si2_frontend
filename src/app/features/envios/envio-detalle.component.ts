...
/**
 * Detalle del envío (modal) + acciones según el estado.
 *
 ...
 * seguridad (el backend no restringe por sucursal, ver ).
 *
...
export class EnvioDetalleComponent {
 ...
 // --------------------------------------------- asignación a AGENCIA
 /** Repartidor propio o agencia de reparto: mutuamente excluyentes. */
