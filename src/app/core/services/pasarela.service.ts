...
export class PasarelaService {
 ...
 /**
 * Inicia una transacción de pago en la pasarela.
 ...
 */
 ...
 /**
 * Procesa el pago directo con tarjeta en la pasarela nativa AttentionPay.
 */
 ...
 /**
 * Genera una sesión oficial de pago con Stripe Checkout Sessions API.
 */
 crearSesionStripe(
 payload: any,
 ...
 /**
 * Valida el estado de la sesión de Stripe Checkout al retornar de la pasarela y liquida la compra.
 */
 ...
 /**
 * Valida el abono por QR institucional y liquida la compra en tiempo real.
 */
