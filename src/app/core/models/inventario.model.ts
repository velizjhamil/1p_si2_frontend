/**
 * Gestión de Inventario: modelos del contrato.
...
/** Tipos de movimiento de stock del kardex. */
...
/** Stock actual por producto (tabla principal ). */
...
/** Umbrales de alerta visual (badges de stock). */
