/**
 * CU18 — Gestión de Envío: modelos del contrato backend.
 *
...
export interface Envio {
  ...
  /**
   * CU19 — agencia de reparto (alternativa al repartidor propio; nunca ambos).
...
/**
 * PATCH /envios/{id}/asignar con AGENCIA de reparto (CU19). Exclusivo con
