/**
 * Gestión de Productos de Ropa: modelos del contrato backend
 * (/api/v1/productos — FastAPI + SQLAlchemy).
 */

/** Estados del producto (ciclo de vida comercial, no stock ). */
...
/** Registro del catálogo /api/v1/tallas (read-only para selects de ). */
...
/** Registro del catálogo /api/v1/colores (read-only para selects de ). */
